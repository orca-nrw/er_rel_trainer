 ...
 * @author André Kless <andre.kless@h-brs.de> 2017-2021
...
( () => {
  ...
  const component = {
    ...
    config: {
      "css": [ "ccm.load",
        [  // serial
          "https://eild-nrw.github.io/er_rel_trainer/versions/latest/libs/bootstrap-4/css/bootstrap.min.css",
          "https://eild-nrw.github.io/er_rel_trainer/versions/latest/libs/user/resources/styles.min.css"
        ]
      ],
//    "guest": "guest",
//    "hash": [ "ccm.load", "https://eild-nrw.github.io/er_rel_trainer/versions/latest/libs/md5/md5.min.mjs" ],
      ...
      "html": [ "ccm.get", "https://eild-nrw.github.io/er_rel_trainer/versions/latest/libs/user/resources/resources.min.js", "html" ],
//    "logged_in": true,
...
//    "onchange": event => console.log( 'User has logged ' + ( event ? 'in' : 'out' ) + '.' ),
      "picture": "https://eild-nrw.github.io/er_rel_trainer/versions/latest/libs/user/resources/icon.svg",
      "realm": "guest",
//    "restart": true,
//    "store": "ccm-user",
