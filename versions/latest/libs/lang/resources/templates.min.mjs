import{html,render}from"https://eild-nrw.github.io/er_rel_trainer/versions/latest/libs/lit/lit.min.js";export{render};export function main(languages,active,onChange){return html`
