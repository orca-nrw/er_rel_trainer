...
//    "guest": "guest",
//    "hash": [ "ccm.load", "https://eild-nrw.github.io/er_rel_trainer/versions/v2/libs/md5/md5.min.mjs" ],
...
//    "onchange": event => console.log( 'User has logged ' + ( event ? 'in' : 'out' ) + '.' ),
      "picture": "https://eild-nrw.github.io/er_rel_trainer/versions/v2/libs/user/resources/icon.svg",
      "realm": "guest",
//    "restart": true,
//    "store": "ccm-user",
