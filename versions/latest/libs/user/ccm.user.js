...
( () => {
  ...
  const component = {
    ...
    config: {
      "css": [ "ccm.load",
        [  // serial
          "https://eild-nrw.github.io/er_rel_trainer/versions/latest/libs/bootstrap-4/css/bootstrap.css",
          "https://eild-nrw.github.io/er_rel_trainer/versions/latest/libs/user/resources/styles.css"
        ]
      ],
//    "guest": "guest",
