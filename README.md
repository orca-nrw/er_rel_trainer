...
<br>
Der `versions`-Ordner enthält alles was nötig ist, um auch ältere Version weiterhin lauffähig zu halten und um die Anwendung auch in anderen Webseiten flexibel einsetzen zu können.
